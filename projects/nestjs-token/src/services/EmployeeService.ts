...
export default class EmployeeService implements IEmployeeService {
  public constructor(@Inject(TYPES.ProjectService) private _projectService: IProjectService) {}
  ...
  async getEmployee(id: number): Promise<Employee> {
    ...
    return new Employee(id, `dummy_name_${id}`, 'male', Math.random() * 100, project);
  }
